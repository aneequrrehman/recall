 ...
 *
 * This is a simplified version that uses the recall() wrapper
 * instead of manually querying and injecting memories.
 *
 * Compare with /api/chat/route.ts to see the difference.
 */
